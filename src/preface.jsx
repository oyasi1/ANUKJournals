...
*/}
      ...
      <section className="mb-8 text-center">
        ...
        <ol className="space-y-4 max-w-3xl mx-auto text-left">
          <li className="text-base sm:text-lg text-gray-700 leading-relaxed">
            ...
            Innovative transport technologies and practices, including clean urban transport innovations, digitalization of operations, and investments in sustainable mobility that serve both people and the planet.
          </li>
          <li className="text-base sm:text-lg text-gray-700 leading-relaxed">
            <span className="font-semibold">2. </span>
            Empirical studies focusing on solving Africa's distinctive transport and mobility challenges, including infrastructure development, modernization, and governance models for global competitiveness.
          </li>
          <li className="text-base sm:text-lg text-gray-700 leading-relaxed">
      ...
      <section className="mb-8">
        ...
        <div className="mb-6">
          <h3 className="text-lg sm:text-xl font-semibold text-blue-800 mb-3">Disclaimer</h3>
          <p className="text-base sm:text-lg text-gray-700 leading-relaxed text-justify mb-4">
            All statements, conclusions, and opinions expressed in individual articles in AJoT are those of the authors and do not necessarily represent the official position or endorsement of CIoTA Nigeria, the publisher, or the journal's editorial board. Thus, the journal accepts no responsibility or liability for them.
          </p>
          <p className="text-base sm:text-lg text-gray-700 leading-relaxed text-justify">
            The journal will use its best endeavours to ensure that work published is that of the named authors and that the published results and conclusions are consistent with the primary data. However, it takes no responsibility for fraud or inaccuracy on the part of the authors.
      ...
      <section className="mb-8">
        ...
        <p className="text-base sm:text-lg text-gray-700 leading-relaxed text-justify mb-4">
          AJoT charges authors a publication fee of ₦15,000.00 or $100.00 per published article for authors who wish to get the hardcopies of the publications. The subscription rate including VAT and postage is ₦2,500.00 or $15.00 per issue to have access to the online publications. The publication charge and subscription rate are subject to review at any time depending on the prevailing cost of publication.
        </p>
        <p className="text-base sm:text-lg text-gray-700 leading-relaxed text-justify">
      ...
      <section className="mb-8">
        ...
        <div className="mb-6">
          <h3 className="text-lg sm:text-xl font-semibold text-blue-800 mb-3">Presentation Pattern for Paper Submission</h3>
          <ul className="space-y-2 text-base sm:text-lg text-gray-700">
            <li>• Paper format: A4 size, not more than 18 pages, double-spacing</li>
            <li>• Font: Times New Roman, 12-point for main text</li>
            <li>• Language: British English</li>
          </ul>
        </div>

        <div>
          <h3 className="text-lg sm:text-xl font-semibold text-blue-800 mb-3">Format</h3>
          <ol className="space-y-2 text-base sm:text-lg text-gray-700">
            <li>1. Title of paper</li>
            <li>2. Name of author(s) with affiliations</li>
            <li>3. Address, email, and telephone number of corresponding author</li>
            <li>4. Abstract (not more than 250 words)</li>
            <li>5. Keywords (5-7 terms)</li>
            <li>6. Body of text:</li>
            <li className="ml-4">• Introduction</li>
            <li className="ml-4">• Literature Review</li>
            <li className="ml-4">• Methodology</li>
            <li className="ml-4">• Findings & Discussion</li>
            <li className="ml-4">• Conclusion & Recommendations</li>
            <li>7. References (APA Style)</li>
